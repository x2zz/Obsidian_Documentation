...
export type Components<T extends AnyOrama, TSchema, TIndex, TDocumentStore, TSorter, TPinning> = Partial<ObjectComponents<TIndex, TDocumentStore, TSorter, TPinning> & FunctionComponents<TSchema> & SingleOrArrayCallbackComponents<T>>;
...
export type Orama<TSchema, TIndex = IIndex<Index>, TDocumentStore = IDocumentsStore<DocumentsStore>, TSorter = ISorter<Sorter>, TPinning = IPinning<AnyPinningStore>> = FunctionComponents<TSchema> & Internals<TSchema, AnyGenericIndex<TIndex>, AnyGenericDocumentStore<TDocumentStore>, AnyGenericSorter<TSorter>, AnyGenericPinning<TPinning>> & ArrayCallbackComponents<any> & OramaID & {
    plugins: OramaPlugin[];
};
export type AnyOrama<TSchema = any> = FunctionComponents<TSchema> & Internals<TSchema, AnyIndexStore, AnyDocumentStore, AnySorterStore, AnyPinningStore> & ArrayCallbackComponents<any> & OramaID & {
    plugins: OramaPlugin[];
};
