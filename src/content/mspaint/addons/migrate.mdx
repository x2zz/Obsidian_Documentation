...
For more information on how to migrate each type of element, check out the [Obsidian](https://github.com/Naellx/Obsidian/blob/main/Example.lua) documentation.
